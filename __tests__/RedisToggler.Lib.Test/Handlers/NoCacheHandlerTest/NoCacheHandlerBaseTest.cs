...
namespace RedisToggler.Lib.Test.Handlers.NoCacheHandlerTest;

public class NoCacheHandlerBaseTest : IDisposable
{
    ...
    internal Mock<ILogger<NoCacheHandler>> Logger { get; } = new(MockBehavior.Loose);
    ...
    internal INoCacheHandler BuildNoCache() => new NoCacheHandler(
        Logger.Object);
}
